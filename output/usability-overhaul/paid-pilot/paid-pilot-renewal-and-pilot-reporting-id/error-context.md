...
- Name: paid-pilot.spec.ts >> renewal and pilot reporting id
...
Locator: getByText('Porsi', { exact: true }).first()
Expected: visible
Timeout: 20000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByText('Porsi', { exact: true }).first() with timeout 20000ms
  - waiting for getByText('Porsi', { exact: true }).first()

```

```yaml
- link "Lewati ke konten":
  - /url: "#main"
- text: Demo eksplorasi · Katerer, menu, dan transaksi menggunakan data sintetis.
- banner:
  - link "Catera — Good Food on Repeat":
    - /url: /
    - img "Catera"
  - navigation:
    - link "Jelajah katering":
      - /url: /#packages
    - link "Makanan saya":
      - /url: /home
    - link "Jadwal makan":
  ...
  - link "Notifikasi":
    - /url: /notifications
  - button "Buka menu akun"
- main:
  - link "Kembali ke paket":
    - /url: /packages/ayam-panggang
  - heading "Siapkan hari-hari yang lebih enak." [level=1]
  - paragraph: Porsi dan jadwal yang jelas, sejak awal.
  - text: 1. Porsi & jadwal 2. Tinjau paket 3. Pembayaran
  - heading "Paket untuk siapa saja?" [level=2]
  - paragraph: Jumlah porsi tetap untuk seluruh paket. Semua porsi mendapat menu yang sama.
  - strong: Porsi setiap hari
  - button "Kurangi porsi" [disabled]
  - strong: "1"
  - button "Tambah porsi"
  - text: Mulai tanggal
  - button "Mulai tanggal": 23 September 2026
  - text: Alamat pengantaran
  - combobox "Alamat pengantaran": Rumah — Jl. Contoh No. 12, Kebayoran Baru, Jakarta Selatan
  - link "Tambah alamat":
  ...
  - group: Punya kode promo?
  - button "Tinjau jadwal & harga"
  - complementary:
    - img "Ayam Panggang Harian"
    - text: Dapur Senja
    - heading "Ayam Panggang Harian" [level=2]
    - strong: Nasi box
    - paragraph: 620 kkal · 32 g protein · 78 g karbohidrat · 20 g lemak Per porsi makan · estimasi katerer
    - paragraph: Makan siang · Menu belum ditentukan
    - paragraph: 1 Nasi · 1 Lauk · 1 Sayur · 1 Pelengkap
    - list
    - paragraph: 5 hari · Makan siang · 1 porsi
    - term: Harga paket
    - definition: Rp 175.000
    - term: Pengantaran
    - definition: Termasuk
    - term: Biaya layanan Catera
    - definition: Dihitung saat tinjau
    - strong: Total
    - strong: —
    - paragraph: Tidak ada perpanjangan otomatis. Pembayaran diproses di dalam Catera.
- contentinfo:
  - link "Catera — Good Food on Repeat":
    - /url: /
    - img "Catera"
  - paragraph: Makanan baik, untuk hari-hari yang lebih baik.
  - link "Jelajah katering":
    - /url: /#packages
  - link "Menjadi mitra":
    - /url: /seller/onboarding
  - link "Identitas Catera":
    - /url: /brand
